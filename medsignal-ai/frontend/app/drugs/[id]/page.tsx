...
import type { Drug, DrugLabel, EventTrends, SafetySummary } from "@/lib/api-types";
    ...
    async function loadDashboard() {
      ...
      try {
        ...
        const eventsResponse = await fetch(
          `${backendUrl}/api/drugs/${params.id}/events?limit=5`,
        );
        ...
        const labelResponse = await labelPromise;
